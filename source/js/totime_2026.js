...
function Time(){
    ...
    function topage(){
        ...
        if (waysec <= 0) {
            ...
            document.getElementById("totimeinfo").innerHTML = "2026/02/16 00:00:00已过去"
        };
    };
...
function Time_2() {
    ...
    var wayday_2 = Math.round(waytime_2 /1000 / 60 / 60 /24);
        ...
        //整个计算程序就是一个大函数
        if (waysec_2 <= 0) {
            document.getElementById("totimeinfo_2").innerHTML = "2026/01/01 00:00:00已过去"
        };
